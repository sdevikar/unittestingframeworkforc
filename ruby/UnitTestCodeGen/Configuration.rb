...
class Configuration
  ...
  @@func_arguments_tag = "<FUNCTION_ARGUMENTS_CSV>"
  @@func_name_tag = "<FUNCTION_NAME>"
  @@param_type_defines_tag = "<PARAM_TYPE_DEFINES>"
  @@global_type_defines_tag = "<GLOBAL_TYPE_DEFINES>"
  ...
  @@code_implementation_template = "resources/UTestImplementation.c"
